...
Changes vs original:
  - FXParameters: added energy_score field (passed to transitions for
...
class FXParameters(BaseModel):
    ...
    lpf_sweep_end_freq: Optional[float] = None
    bpm:                Optional[float] = None
    energy_score:       float           = 0.5  # drives adaptive sigmoid steepness
...
class TransitionRequest(BaseModel):
    ...
    transition_strategy: Literal[
        "bass_swap", "hpf_sweep", "auto_loop", "reverb_wash", "drop_mix",
        "harmonic_mix", "phrase_mix", "lpf_sweep", "echo_out", "loop_roll",
        "long_eq_blend", "energy_blend", "percussion_blend", "breakdown_blend",
        "ambient_transition", "techno_filter_drive",
    ] = "long_eq_blend"
